...
import { World } from "../Components/ui/globe"; // Langsung import komponen tanpa dynamic
    ...
    const links = [
        ...
        return (
            <>
                ...
                {/* Memanggil komponen HeroParallax dengan data produk */}
                <HeroParallax products={products} />



                {/* Bagian Globe dengan konfigurasi dan animasi */}
                <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto dark:bg-black bg-white relative w-full">
                    <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4 mb-10">
                        <motion.div
                ...
                {/* Komponen FloatingDock untuk navigasi */}
